...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-12-2024 a las 00:43:30
...
(100, 3, 2, '2024-11-30', 12312.00, 'r1232', 10, 'Carrera 7c #90', 4, '2024-11-30', 'r232', 'IN'),
(101, 14, 4, '2024-11-08', 1500.00, '12', 7, 'cra 43 sur 56', 5, '2024-11-15', 'r231', 'IN'),
(102, 956, 2, '2024-11-15', 150000.00, '15', 10, '2024-11-15', 4, '2024-11-21', '1520', 'IN'),
(103, 95, 3, '2024-11-06', 150.00, '18', 10, '2024-11-01', 2, '2024-11-15', '23', 'OU'),
(104, -98, 2, '2024-11-08', -150.00, '18', 10, '2024-11-28', 4, '2024-11-20', '23', 'IN'),
(105, -98, 2, '2024-10-30', 150.00, '12', 10, '2024-11-27', 4, '2024-11-05', '23', 'IN'),
(106, 95, 5, '2024-11-30', 150000.00, 'f_22', 10, 'Carrera 7c #90', 5, '2024-11-30', '23', 'IN');
...
(5, '5913064856', 'INSERT', 'Nuevo usuario insertado: Kevin  Rodriguez', 'Sistema', '2024-11-30 18:39:10'),
(6, '1022933535', 'INSERT', 'Nuevo usuario insertado: Andrea Fernandez', 'Sistema', '2024-11-30 18:40:33');
...
(2, 'Desarrollo', 'Prueba en desarrollo', '2024-10-21', 30000.00, -5, 8, 4, 15, '2024-10-22', 1, 'OUT'),
(4, 'medias', 'larga de futbol', '2024-11-30', 123344.00, 12, 8, 3, 14, '2024-11-30', 3, 'IN'),
(5, 'paco', 'l', '2024-11-28', 15000.00, 14, 8, 2, 15, '2024-11-21', 2, 'IN'),
(6, 'Telaa', 'asdasdsadas', '2024-11-30', 150000.00, 150, 8, 1, 15, '2024-11-20', 1, 'IN'),
(7, 'asxdsafdas', 'asdasdsadsa', '2024-11-30', 150.00, 10, 1, 2, 16, '2024-11-30', 2, 'OUT'),
(8, 'Hilo', 'hilo amarillo', '2024-11-30', 150.00, 15, 8, 1, 16, '2024-11-30', 1, 'IN'),
(9, 'Hilo 1', 'hilo amarillo', '2024-12-07', -150.00, 15, 1, 1, 16, '2024-11-21', 1, 'OUT'),
(10, 'Cremalleras', 'Cremalleras  color plateado ', '2024-11-30', 15000.00, 5, 8, 4, 1, '2024-11-30', 4, 'IN'),
(11, 'Tanga Roja', 'Hilo de algodon color rojo', '2024-12-04', 20000.00, 2, 8, 3, 6, '2024-12-05', 5, 'OUT');
...
(1, 8, '2024-11-30', 154000.00, 344, '2024-11-30', 2, 5, 4, 'IN'),
(2, 1, '2024-10-24', 450000.00, 4, '2024-12-02', 2, 4, 1, 'OU'),
(3, 10, '2024-11-12', 150000.00, 15, '2024-12-06', 3, 2, 5, 'OU'),
(4, 10, '2024-11-18', 52.00, 16, '2024-11-19', 3, 2, 5, 'OU'),
(7, 10, '2024-11-07', 150.00, 150, '2024-11-27', 2, 2, 4, 'OU'),
(8, 10, '2024-11-23', 150.00, 12, '2024-11-21', 2, 2, 3, 'OU'),
(9, 10, '2024-11-14', 150.00, 2, '2023-10-20', 2, 6, 4, 'IN'),
(10, 10, '2024-03-29', 150.00, 10, '2023-11-09', 2, 4, 3, 'OU'),
(11, 10, '2024-06-12', 150.00, 4, '2024-11-30', 1, 6, 3, 'OU'),
(12, 10, '2024-10-04', 15000.00, 15, '2024-12-02', 2, 4, 5, 'OU'),
(13, 10, '2024-11-30', 50.00, 15, '2025-03-19', 2, 6, 3, 'IN'),
(14, 10, '2024-11-30', 50.00, 15, '2025-03-19', 2, 6, 3, 'IN'),
(15, 12, '2024-12-04', 25000.00, 3, '2024-12-06', 3, 6, 4, 'IN');
...
CREATE TABLE `productos_terminados` (
  ...
  `DescripcionPT` text DEFAULT NULL,
...
INSERT INTO `productos_terminados` (`idProductos`, `Nombre_Producto`, `Cantidad_Disponible`, `DescripcionPT`, `Fecha_Entrada`, `Fecha_Salida`, `idmateria_prima`, `idEstado`, `status`) VALUES
(1, 'adios', 100, 'Descripción del productos', '2024-12-04', '2024-12-10', 11, 1, 'IN'),
(2, 'Cofias4', 300, 'h', '2024-08-20', '2024-08-20', 8, 5, 'IN'),
(3, 'ChaquetaPromm', 150, 'Aeee', '2024-12-05', '2024-12-20', 5, 1, NULL),
(4, 'Uniforme Vigilante', 50, 'Tela de cortina azul oscuro', '2024-08-12', '2024-08-30', 1, 1, 'OU'),
(5, 'Uniforme enfermeria', 55, 'Tela de cortina azul clarito', '2024-08-15', '2024-09-01', 2, 1, 'OU'),
(30, 'Uniforme SENA', 10, 'j', '2024-12-28', '2024-12-15', 4, 2, 'OU'),
(31, 'Uniforme SENA', 10, 'AA', '2024-11-28', '2024-12-08', 10, 2, 'OU'),
(32, 'TANGA ROJA', 12, 'AAAAAA', '2024-12-19', '2024-12-29', 10, 1, 'IN'),
(35, 'maicol', 1, 'no hay', '2024-12-27', '2024-12-09', 11, 4, NULL),
(36, 'MEDIAS', 11, 'lana', '2024-12-31', '2024-12-13', 11, 3, NULL);
...
(7, 'kevin', 'santiago', 'kevin@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 1, '1022948619', 'cra 6 f sur n34 m', '2000-01-07', '3211140618', 3),
...
(11, 'Kevin ', 'Rodriguez', 'kevin@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 1, '5913064856', 'kr 7c estee 98 56 sur', '1998-02-03', '3161718152', 4),
(12, 'Andrea', 'Fernandez', 'Andresfndez@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 1, '1022933535', 'kr 7c  98 56 sur', '2002-03-02', '3654895689', 4);
...
--
ALTER TABLE `facturas`
  MODIFY `idFacturas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
...
--
ALTER TABLE `productos_terminados`
  MODIFY `idProductos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `productos_terminados`
  ADD CONSTRAINT `FK_MP_PT` FOREIGN KEY (`idmateria_prima`) REFERENCES `materia_prima` (`idProducto`),
  ADD CONSTRAINT `FK_MP_PTs` FOREIGN KEY (`idEstado`) REFERENCES `estados` (`idEstados`);
