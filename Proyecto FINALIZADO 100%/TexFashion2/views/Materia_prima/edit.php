    ...
    <form action="?controller=MateriaPriema&method=update" method="post" onsubmit="return validarFormulario()">
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="Precio_Unidad" value="<?php echo $data[0]->Precio_Unidad ?>" min="0" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Cantidad Stock</label>
                <input type="number" class="form-control" name="Cantidad_Stock" value="<?php echo $data[0]->Cantidad_Stock ?>" min="0" required>
            </div>
