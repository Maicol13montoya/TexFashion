...
<script>
    function validarFormulario() {
        ...
        // Validación para la fecha de emisión no mayor ni menor que la fecha actual
        var fechaEmision = document.querySelector('[name="Fecha_de_Emision"]').value;
        if (fechaEmision > fechaActual || fechaEmision < fechaActual) {
            alert("La fecha de emisión no puede ser mayor ni menor a la fecha actual.");
            return false;
        }
    ...
    // Validación de solo números para el campo Numero_Factura
    document.addEventListener("DOMContentLoaded", function() {
        const inputNumeroFactura = document.getElementById("numeroFactura");

        if (inputNumeroFactura) {
            inputNumeroFactura.addEventListener("keydown", function(e) {
            ...
            inputNumeroFactura.addEventListener("input", function() {
